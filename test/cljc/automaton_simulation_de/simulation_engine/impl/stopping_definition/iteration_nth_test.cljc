(ns
  automaton-simulation-de.simulation-engine.impl.stopping-definition.iteration-nth-test
  (:require
...
(deftest stop-nth-test
  ...
  (testing
    ...
    (is (not (:stop? (sut/stop-nth
                      #:automaton-simulation-de.simulation-engine{:iteration 2}
                      #:automaton-simulation-de.simulation-engine{:n 10})))))
