(ns automaton-simulation-de.simulation-engine.impl.stopping-definition.registry-test
  (:require
   #?(:clj [clojure.test :refer [deftest is testing]]
      :cljs [cljs.test :refer [deftest is testing] :include-macros true])
   [automaton-core.adapters.schema                                              :as core-schema]
   [automaton-simulation-de.simulation-engine.impl.stopping-definition.registry :as sut]))
