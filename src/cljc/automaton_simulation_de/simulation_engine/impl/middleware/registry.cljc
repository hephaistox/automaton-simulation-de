...
(defn build
  ...
  []
  #:automaton-simulation-de.simulation-engine{:state-rendering
                                              sim-de-state-rendering/wrap
                                              :state-printing
                                              sim-de-state-rendering/wrap-print
                                              :tap-request
                                              sim-de-tapping/wrap-request
