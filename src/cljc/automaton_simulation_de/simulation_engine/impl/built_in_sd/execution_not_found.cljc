(ns automaton-simulation-de.simulation-engine.impl.built-in-sd.execution-not-found
...
(def stopping-definition
  #:automaton-simulation-de.simulation-engine{:id ::sim-engine/execution-not-found
                                              :next-possible? true
                                              :doc
