(ns automaton-simulation-de.rc.impl.unblocking-policy.registry
  ...
  (:require
   ...
   [automaton-simulation-de.rc.unblocking-policy           :as sim-de-rc-unblocking-policy]))
...
(defn registry
  ...
  []
  #:automaton-simulation-de.rc{:FIFO sim-de-rc-unblocking-policy-base/fifo-policy
